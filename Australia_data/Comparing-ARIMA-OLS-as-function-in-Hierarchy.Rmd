...
TourismData <-
  read.csv("TourismData_v3.csv", header = TRUE)
TourismData.melt<-melt(TourismData[,-c(1,2)])
TourismData.melt$Split<-c(rep("training", times = 216), rep("Validation", times = 12))
TourismData<-TourismData.melt 
names(TourismData)<-c("Category","Value","Split")
