...
BACBus.Total.PI <- readr::read_csv("Paper-Figures/results_Tourism/BACBus.Total.PI.csv")
```
...
```{r predinttotal, fig.align="center", fig.cap="The actual test set for the 'Total series' compared to the forecasts from reconciled and unreconciled OLS methods with prediction interval for rolling and fixed origin tourism demand.", out.width="100%"}
### total series
p1 <- BACBus.Total.PI %>%
   filter(Series == "Total", ForecastInterval == "1Step") %>%
...
```{r predintBACBus, fig.align="center", fig.cap="The actual test set for the 'BACBus' bottom level series compared to the forecasts from reconciled and unreconciled OLS methods with prediction interval for rolling and fixed origin tourism demand.", out.width="100%"}
...
BACBus.rolling.PI.noise.FH <-  readr::read_csv("Paper-Figures/results_Tourism/Simulation/BACBus.rolling.PI.noise.FH.csv")
BACBus.fix.PI.noise.FH <-  readr::read_csv("Paper-Figures/results_Tourism/Simulation/BACBus.fix.PI.noise.FH.csv")
BACBus.fix.PI.levels.NS <- readr::read_csv("Paper-Figures/results_Tourism/Simulation/BACBus.fix.PI.levels.NS.csv")
BACBus.rolling.PI.levels.NS <- readr::read_csv("Paper-Figures/results_Tourism/Simulation/BACBus.rolling.PI.levels.NS.csv")
...
rmse.sim.noise.FH <- error.sim.tourism.noise.FH %>%
  ...
  spread(value = rmse, key = Method) %>%
  ungroup() %>%
  select(Rec, noise, ForecastHorizon, ARIMA, ETS, OLS)
...
rmse.sim.level.NS.fix <- fc.sim.fix.level.NS %>%
  ...
  spread(value = rmse, key = Method) %>%
  ungroup() %>%
  select(Rec, Series, Levels, ARIMA, ETS, OLS)
...
```{r TourismdatasimPIrollingnoiseFH, results='asis', dependson="Readsimtouris", fig.align="center", fig.cap="The actual test set for one of the bottom level series with different error levels forecasted with ETS, ARIMA and OLS with reconciliation and prediction intervals in one to four years- Rolling origin - 304 bottom level series and 8 levels of hierarchy - Simulated tourism dataset", out.width="100%"}
BACBus.rolling.PI.noise.FH %>%
   ggplot(aes(x = date, y = Actual, colour = "Actual")) +
    geom_ribbon(aes(x = date, ymax = ARIMA.rec.upper, ymin = ARIMA.rec.lower), fill = "lightskyblue", colour = "lightskyblue", alpha = .2) +
...
```{r TourismdatasimPIfixnoiseFH, results='asis', dependson="Readsimtouris", fig.align="center", fig.cap="The actual test set for one of the bottom level series with different error levels forecasted with ETS, ARIMA and OLS with reconciliation and prediction intervals in one to four years- Fixed origin - 304 bottom level series and 8 levels of hierarchy - Simulated tourism dataset", out.width="100%"}
BACBus.fix.PI.noise.FH %>%
   ggplot(aes(x = date, y = Actual, colour = "Actual")) +
    geom_ribbon(aes(x = date, ymax = ARIMA.rec.upper, ymin = ARIMA.rec.lower), fill = "lightskyblue", colour = "lightskyblue", alpha = .2) +
  #geom_ribbon(aes(x = date, ymax =  ARIMA.unrec.upper, ymin = ARIMA.unrec.lower), fill = "orange", colour = "orange", alpha = .3) +
  geom_ribbon(aes(x = date, ymax = ETS.rec.upper, ymin = ETS.rec.lower), fill = "lightgreen", colour = "lightgreen", alpha = .2) +
...
```{r TourismdatasimPIrollinglevelNS, results='asis', dependson="Readsimtouris", fig.align="center", fig.cap="The actual test set for one of the bottom level series with different number of series and hierarchy levels forecasted with ETS, ARIMA and OLS with reconciliation and prediction intervals - Rolling origin - two years forecast points with 0.5 error value - Simulated tourism dataset", out.width="100%"}

BACBus.rolling.PI.levels.NS$SL_f = factor(BACBus.rolling.PI.levels.NS$SL, levels=c('304-8','608-10','1520-12', '3040-18'))

BACBus.rolling.PI.levels.NS %>%
   ggplot(aes(x = date, y = Actual, colour = "Actual")) +
    geom_ribbon(aes(x = date, ymax = ARIMA.rec.upper, ymin = ARIMA.rec.lower), fill = "lightskyblue", colour = "lightskyblue", alpha = .2) +
  #geom_ribbon(aes(x = date, ymax =  ARIMA.unrec.upper, ymin = ARIMA.unrec.lower), fill = "orange", colour = "orange", alpha = .3) +
  geom_ribbon(aes(x = date, ymax = ETS.rec.upper, ymin = ETS.rec.lower), fill = "lightgreen", colour = "lightgreen", alpha = .2) +
...
```{r TourismdatasimPIfixlevelNS, results='asis', dependson="Readsimtouris", fig.align="center", fig.cap="The actual test set for one of the bottom level series with different number of series and hierarchy levels forecasted with ETS, ARIMA and OLS with reconciliation and prediction intervals - Fixed origin - two years forecast points with 0.5 error value - Simulated tourism dataset", out.width="100%"}

BACBus.fix.PI.levels.NS$SL_f = factor(BACBus.fix.PI.levels.NS$SL, levels=c('304-8','608-10','1520-12', '3040-18'))

BACBus.fix.PI.levels.NS %>%
   ggplot(aes(x = date, y = Actual, colour = "Actual")) +
    geom_ribbon(aes(x = date, ymax = ARIMA.rec.upper, ymin = ARIMA.rec.lower), fill = "lightskyblue", colour = "lightskyblue", alpha = .2) +
  #geom_ribbon(aes(x = date, ymax =  ARIMA.unrec.upper, ymin = ARIMA.unrec.lower), fill = "orange", colour = "orange", alpha = .3) +
  geom_ribbon(aes(x = date, ymax = ETS.rec.upper, ymin = ETS.rec.lower), fill = "lightgreen", colour = "lightgreen", alpha = .2) +
...
p1 <- forecast.wiki.data %>%
  filter(Series == "Total", ForecastInterval == "1Step") %>%
  mutate(
    int.low.unrec = OLS.lower.unrec,
    int.high.unrec = OLS.upper.unrec,
    int.low.rec = OLS.lower.rec,
    int.high.rec = OLS.upper.rec
  ) %>%
  ggplot(aes(x = date, y = Actual, colour = "Actual")) +
