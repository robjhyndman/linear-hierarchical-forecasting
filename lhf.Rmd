...
```{r predintdesktopus, fig.align="center", fig.cap="The actual test set for the 'BACBus' bottom level series compared to the forecasts from reconciled and unreconciled OLS methods with prediction interval for rolling and fixed origin  Wikipedia pageviews.", out.width="100%"}
### one series example series
p1 <- forecast.wiki.data %>%
  filter(Series == "desktopusenPho04", ForecastInterval == "1Step") %>%
  mutate(
