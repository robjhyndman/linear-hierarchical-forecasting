...
\caption{Computation time (seconds) for ETS, ARIMA and OLS with  reconciliation - Fixed origin forecasts on one to four year test set and different error values - 304 bottom level series and 8 levels of hierarchy.}\label{fig:TourismsimcomputationtimefixednoiseFH}
\end{figure}
