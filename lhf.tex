...
\caption{The actual test set for one of the bottom level series with different error levels forecasted with ETS, ARIMA and OLS with reconciliation with prediction intervals in one to four years- Fixed origin - 304 bottom level series and 8 levels of hierarchy - Simulated tourism dataset}\label{fig:TourismdatasimPIfixnoiseFH}
\end{figure}
